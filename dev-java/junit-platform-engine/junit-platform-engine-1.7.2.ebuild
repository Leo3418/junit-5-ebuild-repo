...
MAVEN_ID="org.junit.platform:junit-platform-engine:1.7.2"
...
DESCRIPTION="Public API for JUnit Platform test engines"
...
JAVA_SRC_DIR=(
	...
	#src/testFixtures/java # Uses 'var' keyword, thus requires JDK >=11
)
